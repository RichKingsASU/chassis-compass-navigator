...
// Legacy pages (preserved for direct links)
...
export default function ChassisRoutes() {
  return (
    <Suspense fallback={<LoadingFallback />}>
      <Routes>
        <Route path="/" element={<ProtectedPage><FleetOverview /></ProtectedPage>} />
        ...
        {/* Legacy routes preserved for direct links */}
        <Route path="management" element={<ProtectedPage><ChassisManagement /></ProtectedPage>} />
        ...
        {/* Put :id last to avoid matching static routes */}
