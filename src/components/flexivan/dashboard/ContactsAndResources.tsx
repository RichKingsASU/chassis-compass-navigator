      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="space-y-2">
            <div className="font-medium">FLEXIVAN Account Manager</div>
            <div className="flex items-center gap-2 text-sm text-muted-foreground">
              <Mail className="h-4 w-4" />
              <a href="mailto:support@flexivan.com" className="hover:underline">
                support@flexivan.com
              </a>
            </div>
            <div className="flex items-center gap-2 text-sm text-muted-foreground">
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-2 text-sm text-muted-foreground">
              <Mail className="h-4 w-4" />
              <a href="mailto:billing@flexivan.com" className="hover:underline">
                billing@flexivan.com
              </a>
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-2 text-sm text-muted-foreground">
              <Mail className="h-4 w-4" />
              <a href="mailto:tech@flexivan.com" className="hover:underline">
                tech@flexivan.com
              </a>
            </div>
          </div>
          ...
          <div className="space-y-3">
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <span className="text-sm font-medium">FLEXIVAN Portal Guide</span>
              </div>
            ...
            >
              <div className="flex items-center gap-3">
                <FileText className="h-4 w-4 text-muted-foreground" />
                <span className="text-sm font-medium">Dispute Resolution Process</span>
              </div>
              <ExternalLink className="h-4 w-4 text-muted-foreground" />
            </a>
