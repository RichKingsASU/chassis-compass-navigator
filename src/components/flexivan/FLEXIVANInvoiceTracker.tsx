...
interface FLEXIVANInvoiceTrackerProps {
  onViewDetail?: (record: any) => void;
}

const FLEXIVANInvoiceTracker: React.FC<FLEXIVANInvoiceTrackerProps> = ({ onViewDetail }) => {
                ...
                {paginatedData.map((record, index) => {
                  ...
                  return (
                    <tr key={globalIndex} className="border-b hover:bg-gray-50/50 transition-colors">
                      ...
                      <td className="p-3 text-sm">{record.invoice_type || 'N/A'}</td>
