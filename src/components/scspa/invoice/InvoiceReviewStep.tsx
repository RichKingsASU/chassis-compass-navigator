    ...
    <div className="space-y-6">
      ...
      <Card className="p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            <Label htmlFor="provider">Vendor</Label>
            <Select value={invoice.provider || "SCSPA"} onValueChange={(v) => handleInvoiceFieldChange('provider', v)}>
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
          ...
          <div>
            ...
            <Input
              ...
              type="number"
              step="0.01"
              value={Number(invoice.total_amount_usd).toFixed(2)}
              onChange={(e) => handleInvoiceFieldChange('total_amount_usd', parseFloat(e.target.value))}
            />
          </div>
          <div>
