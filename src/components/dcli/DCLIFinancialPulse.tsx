...
const DCLIFinancialPulse = () => {
  const { dashboardMetrics, loading } = useDCLIData();
  ...
  const kpiCards = [
    {
      ...
      value: `$${dashboardMetrics.totalOutstanding.toLocaleString()}`,
    ...
    },
    {
      ...
      value: `$${dashboardMetrics.overdueAmount.toLocaleString()}`,
    ...
    },
    {
      ...
      value: `$${dashboardMetrics.pendingAmount.toLocaleString()}`,
    ...
    },
    {
      ...
      value: `$${dashboardMetrics.monthlyPaid.toLocaleString()}`,
...
export default DCLIFinancialPulse;