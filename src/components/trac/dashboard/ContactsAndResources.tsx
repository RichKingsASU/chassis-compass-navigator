      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="space-y-2">
            <div className="font-medium">TRAC Account Manager</div>
            <div className="flex items-center gap-2 text-sm text-muted-foreground">
              <Mail className="h-4 w-4" />
              <a href="mailto:support@tracintermodal.com" className="hover:underline">
                support@tracintermodal.com
              </a>
            </div>
            <div className="flex items-center gap-2 text-sm text-muted-foreground">
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-2 text-sm text-muted-foreground">
              <Mail className="h-4 w-4" />
              <a href="mailto:billing@tracintermodal.com" className="hover:underline">
                billing@tracintermodal.com
              </a>
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-2 text-sm text-muted-foreground">
              <Mail className="h-4 w-4" />
              <a href="mailto:tech@tracintermodal.com" className="hover:underline">
                tech@tracintermodal.com
              </a>
            </div>
          </div>
        </CardContent>
          ...
          <div className="space-y-3">
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <span className="text-sm font-medium">TRAC Portal Guide</span>
              </div>
