...
const COLUMNS: ColumnDef[] = [
  ...
  { key: 'customer_rate_amount', label: 'Customer Rate', visible: true, width: 110, align: 'right', format: (v) => formatCurrency(v as number | null) },
...
export default function ShortTermChassis() {
  ...
  // Compute KPIs
  const totalRevenue = data.reduce((s, r) => s + (Number(r.customer_rate_amount) || 0), 0)
