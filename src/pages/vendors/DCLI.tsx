...
export default function DCLIPage() {
  ...
  const [activities, setActivities] = useState<DcliActivity[]>([])
    ...
    async function loadData() {
      ...
      try {
        const [invRes, actRes] = await Promise.all([
          supabase.from('dcli_invoice').select('*').order('created_at', { ascending: false }),
          supabase.from('dcli_activity').select('*').order('created_at', { ascending: false }).limit(20),
        ])
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <Card>
              ...
              <CardContent className="space-y-2">
                ...
                <p><span className="font-medium">Hours:</span> Mon–Fri 8am–6pm EST</p>
              </CardContent>
            </Card>
              ...
              <CardContent className="space-y-3">
                ...
                <div className="p-3 bg-blue-50 border border-blue-200 rounded-md">
                  ...
                  <ul className="text-sm text-blue-700 list-disc list-inside mt-1 space-y-1">
                    <li><a href="#" className="underline">DCLI Rate Schedule 2024</a></li>
                    <li><a href="#" className="underline">Chassis Pool Agreement</a></li>
                    <li><a href="#" className="underline">Dispute Process Guide</a></li>
                  </ul>
                </div>
              </CardContent>
            </Card>
