...
import { useTracActivity } from '@/features/trac/hooks/useTracActivity'
import { useVendorKpis } from '@/hooks/useVendorKpis'
import type { TracActivityRow } from '@/features/trac/types'
import { 
  Building2, 
  ExternalLink, 
  ShieldAlert, 
...
const ACTIVITY_TABLE = 'trac_activity'
...
export default function TRACPage() {
  ...
  const { data: activity = [], isLoading: activityLoading } = useTracActivity()

  const handleInvoicesLoaded = useCallback((rows: VendorInvoice[]) => {
    setInvoices(rows)
  }, [])

  const activityColumnDefs = useMemo<ColDef<TracActivityRow>[]>(() => [
    { 
    ...
    <div className="p-8 space-y-8">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-[10px] font-black uppercase tracking-[0.3em] text-muted-foreground">TRAC Intermodal Intelligence</p>
        </div>
      </div>
            ...
            <Card className="border-none shadow-xl bg-card/50 backdrop-blur-sm">
              ...
              <CardContent className="pt-6 space-y-6">
                ...
                <div className="space-y-1">
                  ...
                  <a href="https://tracintermodal.com" className="text-xl font-black text-primary hover:underline flex items-center gap-2" target="_blank" rel="noreferrer">
                    tracintermodal.com
            ...
            <Card className="border-none shadow-xl bg-amber-500/[0.03]">
              ...
              <CardContent className="pt-6">
                <p className="text-sm font-bold text-amber-800 leading-relaxed uppercase tracking-tight">
                  TRAC disputes must be logged via their online portal within 60 days of the invoice date.
                </p>
              </CardContent>
            </Card>
          </div>
