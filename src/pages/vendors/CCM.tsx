...
export default function CCMPage() {
  ...
  const [activities, setActivities] = useState<CcmActivity[]>([])
    ...
    async function loadData() {
      ...
      try {
        const [invRes, actRes] = await Promise.all([
          supabase.from('ccm_invoice').select('*').order('created_at', { ascending: false }),
          supabase.from('ccm_activity').select('*').order('created_at', { ascending: false }).limit(20),
        ])
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <Card>
              ...
              <CardContent className="space-y-2">
                ...
                <p><span className="font-medium">Billing Support:</span> billing@ccmpool.com</p>
                <p><span className="font-medium">Phone:</span> 1-877-226-6224</p>
                <p><span className="font-medium">Provider Code:</span> CCM</p>
              </CardContent>
            </Card>
              ...
              <CardContent className="space-y-3">
                ...
                <div className="p-3 bg-blue-50 border border-blue-200 rounded-md">
                  ...
                  <ul className="text-sm text-blue-700 list-disc list-inside mt-1 space-y-1">
                    <li><a href="#" className="underline">CCM Rate Schedule</a></li>
                    <li><a href="#" className="underline">Pool Agreement</a></li>
