...
const InvoiceLineDispute = () => {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      ...
      <div>
        <h1 className="text-3xl font-bold tracking-tight">Dispute Invoice Line</h1>
      ...
      <Card>
        ...
        <CardContent>
          <p className="text-muted-foreground">
            Dispute submission functionality will be available once WCCP data integration is complete.
          </p>
        </CardContent>
      </Card>
    </div>
