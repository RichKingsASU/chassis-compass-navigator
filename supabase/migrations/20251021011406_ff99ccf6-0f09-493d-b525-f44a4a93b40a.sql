-- Fix chassis days calculation to use correct formula
-- Invoice days = (Tier 1 Days - Tier 1 Free Days) + (Tier 2 Days - Tier 2 Free Days) + (Tier 3 Days - Tier 3 Free Days)
  ...
  LOOP
    ...
    SELECT jsonb_build_object(
      ...
      - CASE 
          ...
          ELSE 0 
        END
      -- Apply penalty for days mismatch using correct formula
      - CASE 
          WHEN v_invoice_billable_days IS NOT NULL AND t.rated_quantity IS NOT NULL 
               AND v_invoice_billable_days != t.rated_quantity 
          THEN 10 
          ELSE 0 
        END,
      'match_reasons', ARRAY[
        ...
        CASE WHEN v_invoice_billable_days IS NOT NULL AND t.rated_quantity IS NOT NULL 
                  AND v_invoice_billable_days = t.rated_quantity 
